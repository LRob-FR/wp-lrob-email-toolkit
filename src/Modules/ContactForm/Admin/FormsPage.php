...
final class FormsPage
{
    ...
    public static function captcha_service(): ?CaptchaService
    {
     ...
     */
    public static function email_field_slugs(array $structure): array
    {
        $slugs = [];
    ...
    public static function render_recipients(string $current_value, string $placeholder, string $key = CPT::META_RECIPIENT): void
    {
    ...
    public static function render_free_combobox(string $meta_key, string $current_value, array $suggestions, string $placeholder = ''): void
    {
        Combobox::render_free_text($meta_key, $current_value, $suggestions, $placeholder, 'lrob-etk-cf-field');
    }

    public static function render_combobox(string $meta_key, string $current_value, array $options, string $inherit_value = ''): void
    {
        ...
        <?php else : ?>
            ...
            <div class="lrob-etk-card-grid lrob-etk-card-grid--wide">
                <?php foreach ($forms as $form) : ?>
                    <?php $this->form_cards->render($form, $identities, $globals); ?>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
        <?php
     ...
     */
    public static function placeholder_default(string $value): string
    {
        return sprintf(
    ...
    public function handle_delete_form(): void
    {
        ...
        // Modal UI in the form card surfaces the choice; if the request
     ...
     * @param array<int, array{id:int, label:string, is_default:bool}> $identities
     */
    public static function default_identity_label(array $identities): string
    {
        foreach ($identities as $identity) {
            if ($identity['is_default']) {
