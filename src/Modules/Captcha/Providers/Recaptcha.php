...
final class Recaptcha extends AbstractHostedCaptcha
{
    ...
    {
        // reCAPTCHA brand mark — white circular-arrows motif on Google blue
        // (#4285f4) inside a rounded rectangle.
        return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="20" height="20" aria-hidden="true" focusable="false">'
            ...
            . '<path d="M18 9a9 9 0 0 1 7.8 4.5l-2.6 1.5A6 6 0 0 0 18 12V9z" fill="#fff"/>'
            . '<path d="M25.8 13.5 27 9l-3.3 1.4 2.1 3.1z" fill="#fff"/>'
            . '<path d="M18 27a9 9 0 0 1-7.8-13.5l2.6 1.5A6 6 0 0 0 18 24v3z" fill="#fff"/>'
            . '<path d="M10.2 22.5 9 27l3.3-1.4-2.1-3.1z" fill="#fff"/>'
            . '</svg>';
    }
}
